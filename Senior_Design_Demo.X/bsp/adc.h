...
#define ADC_CHANNEL_THERMOCOUPLE ADC_CHANNEL_21 // Pin 19/RE9
#define ADC_CHANNEL_RTD ADC_CHANNEL_20 // Pin 14/RG9
#define ADC_CHANNEL_RTD2 ADC_CHANNEL_16 // Pin52/RC4(PIC pin 9 but board pin 52)
